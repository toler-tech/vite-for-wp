<?php
/**
 * Vite integration for WordPress. Borrowed from https://github.com/kucrut/vite-for-wp, adapted by Toler Tech for
 * different ergonimics and for handling CSS.
 *
 * @package ViteForWp
 */
...
if ( ! defined( 'VITE_CLIENT_SCRIPT_HANDLE' ) ) {
	define( 'VITE_CLIENT_SCRIPT_HANDLE', 'vite-client' );
}
...
class Vite {
	 ...
	 */
	public static function get_manifest( string $manifest_dir ): object {
	 ...
	 * @return void
	 */
	public static function filter_script_tag( string $handle ): void {
	 ...
	 */
	public static function set_script_type_attribute( string $target_handle, string $tag, string $handle ): string {
	 ...
	 * @return string
	 */
	public static function generate_development_asset_src( object $manifest, string $entry ): string {
		return sprintf(
			'%s/%s',
	 ...
	 * @return void
	 */
	public static function register_vite_client_script( object $manifest ): void {
		...
		self::filter_script_tag( VITE_CLIENT_SCRIPT_HANDLE );
	}
	 ...
	 * @return void
	 */
	public static function inject_react_refresh_preamble_script( object $manifest ): void {
	 ...
	 */
	public static function load_development_asset( object $manifest, string $entry, array $options ): ?array {
	 ...
	 */
	public static function load_production_asset( object $manifest, string $entry, array $options ): ?array {
	 ...
	 */
	public static function parse_options( array $options ): array {
	 ...
	 * @return string
	 */
	public static function prepare_asset_url( string $dir ) {
